// ignore_for_file: prefer_const_constructors, import_of_legacy_library_into_null_safe, sized_box_for_whitespace
...
class Calcit extends StatefulWidget {
  const Calcit({ Key? key }) : super(key: key);

  @override
  _CalcitState createState() => _CalcitState();
}

class _CalcitState extends State<Calcit> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text('Calcit Calculator'),
      centerTitle: true, ),
      body: Column(
        children: [
          Container(
